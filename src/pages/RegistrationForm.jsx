      ...
      <div className="absolute top-0 left-0 w-full h-full flex flex-col pt-24 z-1">
        <div className="max-w-4xl mx-auto px-4 py-6 h-full flex flex-col">
          ...
          <div className="flex-1 min-h-0 overflow-hidden">
            <div className="bg-white/80 backdrop-blur-sm rounded-xl shadow-lg border border-[#D4B5A0] overflow-hidden h-full flex flex-col">
              <div className="bg-gradient-to-r from-[#F68241] to-[#F3CA62] px-6 py-4 flex-shrink-0">
                <h2 className="text-xl font-semibold text-white flex items-center gap-2">
                  {type === "guide" ? (
                    <>
                      <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          ...
          <div className="bg-gradient-to-r from-[#2D5016]/10 to-[#8B4513]/10 rounded-lg p-6 border border-[#D4B5A0] backdrop-blur-sm mt-6 flex-shrink-0">
